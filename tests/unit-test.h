...
const uint16_t UT_BITS_ADDRESS = 0x07;
const uint16_t UT_BITS_NB = 0x22;
const uint8_t UT_BITS_TAB[] = { 0xCD, 0x6B, 0xB2, 0x0E, 0x03 };

const uint16_t UT_INPUT_BITS_ADDRESS = 0x07;
const uint16_t UT_INPUT_BITS_NB = 0x16;
const uint8_t UT_INPUT_BITS_TAB[] = { 0xAC, 0xDB, 0x35 };

const uint16_t UT_REGISTERS_ADDRESS = 0x0019;
...
const uint16_t UT_INPUT_REGISTERS_ADDRESS = 0x0018;
